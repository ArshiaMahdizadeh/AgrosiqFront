      ...
      <div ref={pageRef} className="space-y-8 p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" className="flex items-center gap-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <CardContent className="space-y-6">
              ...
              <div 
                className={`relative aspect-square max-w-[320px] mx-auto border-2 ${
                  scanning ? "border-primary" : "border-dashed border-gray-300 dark:border-gray-600"
                } rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700`}
              >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="relative">
                  <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[1px] bg-gray-200 dark:bg-gray-700" />
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className={`bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 ${error ? "border-red-500" : ""}`}
                  />
                  <Button
                    variant="outline"
            ...
            <Card ref={resultRef} className="shadow-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  <Badge variant="outline" className="font-mono border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
                    ID: {productId}
                  </Badge>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium text-gray-900 dark:text-white">{product.harvestDate}</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.certifications.map((cert: string, index: number) => (
                      <Badge key={index} variant="secondary" className="flex items-center gap-1 bg-secondary/10 text-secondary-700 dark:text-secondary-300 border-secondary-200 dark:border-secondary-700">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-primary/5 dark:bg-primary/10 rounded-lg border border-primary/20 dark:border-primary/30">
                    <div className="flex items-center gap-2 font-mono text-sm">
                      ...
                      <span className="truncate text-gray-900 dark:text-white">{product.blockchainId}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-4">
                  <Button variant="outline" className="flex-1 bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600">
